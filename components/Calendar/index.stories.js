...
var Container = _styledComponents["default"].div.withConfig({
  ...
  componentId: "fhjvns-0"
})(["width:500px;height:500px;"]);

(0, _react2.storiesOf)('Components 1.0|Calendar', module).addParameters({
  jest: ['Calendar']
}).add('week calendar', function () {
...
(0, _react2.storiesOf)('Components 2.0|Calendar', module).addParameters({
  jest: ['Calendar']
}).add('month calendar', function () {
