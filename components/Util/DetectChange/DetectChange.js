...
/*#__PURE__*/
function (_Component) {
  _inherits(DetectChange, _Component);

  function DetectChange() {
    _classCallCheck(this, DetectChange);

    return _possibleConstructorReturn(this, _getPrototypeOf(DetectChange).apply(this, arguments));
  }

  _createClass(DetectChange, [{
